...
public class DeleteWithOauth {
	...
	public void delete() {
    	...
    	Response response = RestAssured.given().header("Authorization","Bearer Zcr2P-xAYXu63EMjhASdpIUCbJDgVqbLEapop9NUinWgr6x-TKtvx9rJ2o5FmX_GFPVb2SB6J7Kt0prB7ghXjw")
